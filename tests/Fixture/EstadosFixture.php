...
class EstadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'uf' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-12-25 19:17:45',
                'modified' => '2020-12-25 19:17:45',
            ],
        ];
        parent::init();
    }
