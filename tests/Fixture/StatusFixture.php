...
class StatusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_status_grupos1_idx' => ['type' => 'index', 'columns' => ['grupos_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_status_grupos1' => ['type' => 'foreign', 'columns' => ['grupos_id'], 'references' => ['grupos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-12-24 01:53:28',
                'modified' => '2020-12-24 01:53:28',
                'grupos_id' => 1,
            ],
        ];
        parent::init();
