...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'hash' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_users_tipos_idx' => ['type' => 'index', 'columns' => ['tipo_id'], 'length' => []],
            'fk_users_status1_idx' => ['type' => 'index', 'columns' => ['status_id'], 'length' => []],
            'fk_users_marcas1_idx' => ['type' => 'index', 'columns' => ['marca_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_users_marcas1' => ['type' => 'foreign', 'columns' => ['marca_id'], 'references' => ['marcas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_users_status1' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['status', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_users_tipos' => ['type' => 'foreign', 'columns' => ['tipo_id'], 'references' => ['tipos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-12-24 15:41:47',
                'modified' => '2020-12-24 15:41:47',
