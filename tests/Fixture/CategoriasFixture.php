...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_categorias_status1_idx' => ['type' => 'index', 'columns' => ['status_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_categorias_status1' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['status', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-12-24 01:52:29',
                'modified' => '2020-12-24 01:52:29',
                'status_id' => 1,
            ],
        ];
        parent::init();
